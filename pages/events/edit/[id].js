...
export default function EditBrunch({ event, token }) {
   ...
   const handleSubmit = async (e) => {
      ...
      const res = await fetch(`${API_URL}brunches/${event.id}`, {
         method: "PUT",
         headers: {
   ...
   return (
      <Layout title="Add New Event">
         ...
         <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <input type="submit" value="Update Brunch" className="btn" />
         </form>
         <h2>Brunch Image </h2>
         {imagePreview ? (
            <Image src={imagePreview} height={100} width={170} alt="Brunch Image" />
         ) : (
            <div>
